...
namespace v1
{
    public class Lecture : LearnCourse
    {
        string date;
        string lectureTheme;
        int numberStudents;
        ...
        public void Show()
        {
            Console.WriteLine($"Назва курсу {name} Викладач {lastNameTeacher} дата {date} тема {lectureTheme} кількіість студентів {numberStudents} id {id} ");
        }
        ...
        {
            if (lectureTheme.Contains(_search))
                Show();
        }
